...
sys.path.insert(0,os.path.join(ROOT,'research','recheck')); import apply as recheck; recheck.apply_file(os.path.join(ROOT,'KG모빌리티(쌍용)_models.xlsx'))  # 2005+ 불확실 행 재조사 결과
