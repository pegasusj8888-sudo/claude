...
from notation import apply_file; apply_file(os.path.join(ROOT,'벤츠_models.xlsx'))  # 칩코드·부품번호 표기 통일
sys.path.insert(0,os.path.join(ROOT,'research','recheck')); import apply as recheck; recheck.apply_file(os.path.join(ROOT,'벤츠_models.xlsx'))  # 2005+ 불확실 행 재조사 결과
