...
"- 벤츠 키는 ID46 같은 일반 트랜스폰더가 아니라 NEC 프로세서 키(FBS3/FBS4)라서 'XT27A/A66·XT27B·XT57B 호환' 칸은 비어 있습니다(기아 파일 규칙상 해당 칩 없음). G클래스 2000~2001년식(ID44 추정)만 O/O/O입니다.",
...
'',
'※ 색상',
"- 주황색: 추정이거나 자료가 서로 다른 값 — 실물 키/VIN으로 재확인.",
...
"- G클래스(W463) 구형은 2002~2012년 EIS 스마트키 자료와 ID44 트랜스폰더 막대키(2004-2011 G500) 자료가 상충하고, 2016년식은 FBS3/FBS4 의견이 갈려 주황색으로 표시했습니다."]
